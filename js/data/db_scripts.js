...
// 開局創角事件
    'evt_start_game': [
        ...
        { type: "roll_stats" },
        { type: "dialog", speaker: "系統", text: "天命已定！按 WASD 移動。尋找地圖上的【匠】領取裝備，再挑戰【惡】、【徒】、【護】。<br><br><span style='color:#ffff55; font-size:14px;'>※ 日本語のプレイヤーへ：右側の「攻略」タブから日本語ガイドを確認できます。</span>" }
    ],
    // 鐵匠給予新手裝備、傷藥與開放商店
    'evt_npc_blacksmith': [
